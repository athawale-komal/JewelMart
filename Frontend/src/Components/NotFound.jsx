...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-150 via-amber-200 to-slate-250 flex items-center justify-center p-4 ">
      <div className="max-w-2xl w-full ">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <div className="relative mb-6">
            <h2 className="text-9xl md:text-[12rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 leading-none">
              404
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
            >
