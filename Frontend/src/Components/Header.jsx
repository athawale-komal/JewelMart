    ...
    >
      <div className="w-full flex items-center justify-between px-8 lg:px-20 py-4">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <div className={`p-1.5 rounded-lg transition-all duration-500 ${
            ...
            <Gem className={`w-6 h-6 transition-colors duration-500 ${
              isScrolled ? 'text-white' : 'text-amber-600'
            }`} />
          </div>
          <span className={`text-xl sm:text-2xl font-bold tracking-tight transition-colors duration-500 ${
        ...
        <nav className="hidden lg:flex items-center gap-6 xl:gap-12">
          ...
          <div className="relative search-container">
            <form onSubmit={handleSearch} className="relative group">
              ...
              <input
                ...
                className={`pl-9 pr-4 py-2.5 rounded-full w-48 xl:w-64 focus:ring-2 focus:ring-amber-500/30 outline-none transition-all duration-500 ${
                  isScrolled 
          ...
          >
            <button className={`flex items-center gap-1.5 font-semibold px-4 py-2.5 rounded-lg transition-all duration-300 ${
              isScrolled 
          ...
          <Link 
            to="/ai-stylist" 
            className={`flex items-center gap-2 font-semibold px-4 py-2.5 rounded-full border-2 transition-all duration-300 hover:scale-105 ${
              isScrolled 
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <Link 
            ...
            className={`relative transition-all duration-300 hover:scale-110 ${
              isScrolled ? 'text-slate-700 hover:text-amber-600' : 'text-white hover:text-amber-100'
            }`}
          >
          ...
          {isLoggedIn ? (
            ...
            >
              ...
              >
                <div className={`w-9 h-9 rounded-full flex items-center justify-center overflow-hidden transition-all duration-500 hover:scale-110 ${
                  isScrolled 
            ...
            <button
              ...
              className={`hidden sm:flex items-center gap-2 font-semibold px-5 py-2.5 rounded-lg transition-all duration-300 hover:scale-105 ${
                isScrolled 
      ...
      {mobileOpen && (
        <div className={`lg:hidden border-t transition-all duration-300 ${
          isScrolled ? 'bg-white border-stone-200' : 'bg-white/95 backdrop-blur-lg border-white/50'
        }`}>
