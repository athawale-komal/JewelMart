...
export const UPDATE_ORDER_STATUS_ADMIN_REQUEST = 'UPDATE_ORDER_STATUS_ADMIN_REQUEST';
export const UPDATE_ORDER_STATUS_ADMIN_SUCCESS = 'UPDATE_ORDER_STATUS_ADMIN_SUCCESS';
export const UPDATE_ORDER_STATUS_ADMIN_FAILURE = 'UPDATE_ORDER_STATUS_ADMIN_FAILURE';
...
export const GET_DELETED_HISTORY_REQUEST = 'GET_DELETED_HISTORY_REQUEST';
export const GET_DELETED_HISTORY_SUCCESS = 'GET_DELETED_HISTORY_SUCCESS';
export const GET_DELETED_HISTORY_FAILURE = 'GET_DELETED_HISTORY_FAILURE';
...
export const DELETE_HISTORY_ITEM_FAILURE = 'DELETE_HISTORY_ITEM_FAILURE';
